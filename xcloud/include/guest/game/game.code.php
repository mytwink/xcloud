...
if(!isset($_SESSION['game'.$url[2]])){
    $_SESSION['game'.$url[2]] = 1;
    DB::query('UPDATE `game` SET `popular` = `popular`+1 WHERE `id`=?',[$url[2]]);
}
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="img-wrapper">
                    <img class="img-responsive" src="images/cover/game/<?php echo $info['img']; ?>" />
                </div>
                    ...
                    <div class="cur">
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-3 col-xs-12">
                                <a href="images/screen/game/<?php echo $s; ?>" rel="screens" onclick="return jsiBoxOpen(this)">
                                    <img class="col-xs-12" src="images/screen/game/<?php echo $s; ?>" style="margin-top: 5px;"></a>
                            </div>
