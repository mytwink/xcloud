        ...
        <div class="row">
			<?php
				if(!isset($_SESSION['login'])||strlen($_SESSION['login'])<3)
					...
					<div class="row">
						<form action="/" enctype="multipart/form-data" method="POST">
							...
							<select name="lang" class="form-control">
								...
								<option value="gcc">GNU G++ Compiler</option>
					...
					<iframe width="100%" height="300px" allowfullscreen frameborder="0" src="//storage.googleapis.com/vrview/index.html?image=https://medsa.uz/lochin.jpg&is_stereo=true"></iframe>
					<?php
					if (!empty($_FILES)){
