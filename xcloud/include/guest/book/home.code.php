<div class="container-projects bg-primary">
    <div class="container">
        ...
        <div class="row">
            ...
            $res = DB::query('SELECT `id`, `title`, `des`, `img` FROM `book` ORDER BY `popular` DESC LIMIT 4',[])->fetchAll(PDO::FETCH_ASSOC);
            ...
            foreach($res as $r){
                ...
                <div class="col-md-3" style="margin-bottom: 50px;">
                    <a href="book/<?php echo $r['id']; ?>/">
                        <div class="img-wrapper">
                            <div class="title bg-<?php echo $bgr; ?>"><?php echo $r['title']; ?></div>
                            <img class="img-responsive" src="images/cover/book/<?php echo $r['img']; ?>" />
...
<div class="container-projects bg-warning">
    <div class="container">
        ...
        <div id="content" class="row">
            ...
            $res = DB::query('SELECT `id`, `title`, `des`, `img` FROM `book` ORDER BY `added` DESC LIMIT 8',[])->fetchAll(PDO::FETCH_ASSOC);
