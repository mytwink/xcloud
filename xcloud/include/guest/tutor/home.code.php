<div class="container-projects bg-primary">
    <div class="container">
        ...
        <div class="row">
            ...
            $res = DB::query('SELECT `id`, `title`, `des`, `img` FROM `tutor` ORDER BY `popular` DESC LIMIT 4',[])->fetchAll(PDO::FETCH_ASSOC);
...
<div class="container-projects bg-warning">
    <div class="container">
        ...
        <div id="content" class="row">
            ...
            $res = DB::query('SELECT `id`, `title`, `des`, `img` FROM `tutor` ORDER BY `added` DESC LIMIT 8',[])->fetchAll(PDO::FETCH_ASSOC);
